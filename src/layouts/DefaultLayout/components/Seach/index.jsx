function Search() {
    return (
        <div className="relative w-full max-w-[458px] ml-[50px]">
            <input
                type="text"
                className="bg-white rounded-full shadow-[10px_10px_20px_rgba(218, 213, 213, 0.15)] pl-5 py-3 pr-22 w-full text-sm placeholder:text-text4 text-text1"
                placeholder="Do fundraise now"
            />
            <button className="absolute right-[2px] top-1/2 -translate-y-1/2 w-[72px] h-10 rounded-full bg-primary text-white flex items-center justify-center cursor-pointer hover:opacity-80">
                <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
